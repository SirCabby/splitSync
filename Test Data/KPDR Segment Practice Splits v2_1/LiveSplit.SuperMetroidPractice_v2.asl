...
startup
{
    ...
    settings.Add("specificMissiles", true, "Specific Missile Packs", "ammoPickups");
    ...
    settings.Add("brinstarMissiles", true, "Brinstar Missile Packs", "specificMissiles");
    ...
    settings.Add("chargeMissiles", true, "Charge Missile Pack", "brinstarMissiles");
    ...
    settings.Add("alphaMissiles", true, "Alpha Missile Pack", "brinstarMissiles");
    ...
    settings.Add("specificSupers", true, "Specific Super Missile Packs", "ammoPickups");
    ...
    settings.Add("earlySupers", true, "Early Super Missile Pack", "specificSupers");
    ...
    settings.Add("wreckedShipLeftSupers", true, "Wrecked Ship Left Super Missile Pack", "specificSupers");
    ...
    settings.Add("spazer", true, "Spazer", "beamUpgrades");
    ...
    settings.Add("ice", true, "Ice Beam", "beamUpgrades");
    settings.SetToolTip("ice", "Split on picking up the Ice Beam");
    settings.Add("plasma", true, "Plasma Beam", "beamUpgrades");
    settings.SetToolTip("plasma", "Split on picking up the Plasma Beam");

    settings.Add("bootUpgrades", true, "Boot Upgrades");
    ...
    settings.Add("spaceJump", true, "Space Jump", "bootUpgrades");
    settings.SetToolTip("spaceJump", "Split on picking up Space Jump");
    settings.Add("speedBooster", true, "Speed Booster", "bootUpgrades");
    settings.SetToolTip("speedBooster", "Split on picking up the Speed Booster");

    settings.Add("energyUpgrades", true, "Energy Upgrades");
    ...
    settings.Add("specificETanks", true, "Specific Energy Tanks", "energyUpgrades");
    ...
    settings.Add("terminatorETank", true, "Terminator Energy Tank", "specificETanks");
    ...
    settings.SetToolTip("etecoonsETank", "Split on picking up the Energy Tank in the Etecoon Energy Tank Room");
    ...
    settings.Add("kraidETank", true, "Warehouse Energy Tank", "specificETanks");
    ...
    settings.Add("botwoonETank", true, "Botwoon Energy Tank", "specificETanks");
    ...
    settings.Add("miscUpgrades", true, "Misc Upgrades");
    settings.SetToolTip("miscUpgrades", "Split on the miscellaneous upgrades");
    settings.Add("morphBall", true, "Morphing Ball", "miscUpgrades");
    settings.SetToolTip("morphBall", "Split on picking up the Morphing Ball");
    settings.Add("bomb", true, "Bomb",  "miscUpgrades");
    ...
    settings.Add("miniBossRooms", true, "Miniboss Rooms", "areaTransitions");
    settings.SetToolTip("miniBossRooms", "Split on entering miniboss rooms (except Bomb Torizo)");
    settings.Add("bossRooms", true, "Boss Rooms", "areaTransitions");
    settings.SetToolTip("bossRooms", "Split on entering major boss rooms");
    settings.Add("elevatorTransitions", true, "Elevator transitions", "areaTransitions");
    ...
    settings.Add("theClimb", true, "The Climb", "areaTransitions");
    settings.SetToolTip("theClimb", "Split on moving from The Climb to Parlor, will split during escape as well");
    settings.Add("greenHills", true, "Green Hills", "areaTransitions");
    settings.SetToolTip("greenHills", "Split on moving from Big Pink to Green Hills");
    settings.Add("belowSpazer", true, "Below Spazer", "areaTransitions");
    settings.SetToolTip("belowSpazer", "Split on moving from the room below Spazer from Skree Boost room");
    settings.Add("wreckedShipEntrance", true, "Wrecked Ship Entrance", "areaTransitions");
    settings.SetToolTip("wreckedShipEntrance", "Split on entering the Wrecked Ship Entrance from the lower door of West Ocean");
    settings.Add("kraidsLair", true, "Kraid's Lair", "areaTransitions");
    settings.SetToolTip("kraidsLair", "Split on entering Kraid's Lair");
    settings.Add("warehouseKiHunters", true, "Leaving Mini Kraid", "areaTransitions");
    settings.SetToolTip("warehouseKiHunters", "Leaving Mini Kraid Hallway into Warehouse Kihunters Room");
    settings.Add("leavingHiJumpBoots", true, "Leaving Hi Jump Boots", "areaTransitions");
    settings.SetToolTip("leavingHiJumpBoots", "Split on entering Business Center after leaving Hi Jump Boots");
    settings.Add("risingTideEntrance", true, "Rising Tide Entrance", "areaTransitions");
    settings.SetToolTip("risingTideEntrance", "Split on entering Rising Tide from Cathedral");
    settings.Add("redTowerBottomEntrance", true, "Red Tower Bottom Entrance", "areaTransitions");
    settings.SetToolTip("redTowerBottomEntrance", "Split on entering Red Tower from Skree Boost room");
    settings.Add("hellway", true, "Hellway", "areaTransitions");
    settings.SetToolTip("hellway", "Split on entering Hellway from either direction");
    settings.Add("atticExit", true, "Attic Exit", "areaTransitions");
    settings.SetToolTip("atticExit", "Split on exiting Attic");
    settings.Add("tubeBroken", true, "Tube Broken", "areaTransitions");
    settings.SetToolTip("tubeBroken", "Split on blowing up the tube to enter Maridia");
    settings.Add("cacEntry", true, "Cacatack Alley Entry", "areaTransitions");
    settings.SetToolTip("cacEntry", "Split on entering East Cacattack Alley");
    settings.Add("cacExit", true, "Cacatack Alley Exit", "areaTransitions");
    settings.SetToolTip("cacExit", "Split on exiting West Cacattack Alley");
    settings.Add("toilet", true, "Toilet Bowl", "areaTransitions");
    settings.SetToolTip("toilet", "Split on entering Toilet Bowl from either direction");
    settings.Add("kronicBoost", true, "Kronic Boost Room", "areaTransitions");
    settings.SetToolTip("kronicBoost", "Split on entering Kronic Boost room");
    settings.Add("lowerNorfairEntrance", true, "Lower Norfair Entrance", "areaTransitions");
    settings.SetToolTip("lowerNorfairEntrance", "Split on the elevator down to Lower Norfair");
    settings.Add("writg", true, "Worst Room in the Game", "areaTransitions");
    settings.SetToolTip("writg", "Split on entering Worst Room in the Game");
    settings.Add("redKiShaft", true, "Red Kihunter Shaft", "areaTransitions");
    ...
    settings.Add("metalPirates", true, "Metal Pirates Room", "areaTransitions");
    settings.SetToolTip("metalPirates", "Split on entering Metal Pirates Room from Wasteland");
    settings.Add("lowerNorfairSpringMaze", true, "Lower Norfair Springball Maze Room", "areaTransitions");
    settings.SetToolTip("lowerNorfairSpringMaze", "Split on entering Lower Norfair Springball Maze Room");
    settings.Add("lowerNorfairExit", true, "Lower Norfair Exit", "areaTransitions");
    ...
    settings.Add("bombTorizo", true, "Bomb Torizo", "miniBosses");
    ...
    settings.Add("botwoon", true, "Botwoon", "miniBosses");
    ...
    settings.Add("mb1", true, "Mother Brain 1", "bosses");
    ...
    settings.Add("mb3", true, "Mother Brain 3", "bosses");
    ...
    vars.roomIDEnum = new Dictionary<string, int> {
        ...
        { "halfieClimbRoom",                0xD913 },
        { "botwoon",                        0xD95E },
        { "spaceJump",                      0xD9AA },
        { "westCactusAlley",                0xD9FE },
        { "eastCactusAlley",                0xDA2B },
        { "draygon",                        0xDA60 },
...
init
{
    ...
    vars.watchers = new MemoryWatcherList
    {
        ...
        new MemoryWatcher<byte>(memoryOffset + 0xFB00) { Name = "ram_load_preset" },
        new MemoryWatcher<byte>(memoryOffset + 0xFB16) { Name = "ram_seg_rt_seconds" },
        new MemoryWatcher<byte>(memoryOffset + 0xFB18) { Name = "ram_seg_rt_minutes" },
    };
}
...
start
{
    ...
    // Start from a preset on the practice hack
    var presetStart    = vars.watchers["ram_seg_rt_minutes"].Current == 0  && vars.watchers["ram_seg_rt_seconds"].Current == 0 && vars.watchers["gameState"].Current == 8;
    if (normalStart || cutsceneEnded || zebesStart || presetStart) {
        vars.DebugOutput("Timer started");
    }
    return normalStart || cutsceneEnded || zebesStart || presetStart;
}
...
split
{
    ...
    var theClimb = settings["theClimb"] && vars.watchers["roomID"].Old == vars.roomIDEnum["climb"] && vars.watchers["roomID"].Current == vars.roomIDEnum["parlor"];
    var greenHills = settings["greenHills"] && vars.watchers["roomID"].Old == vars.roomIDEnum["bigPink"] && vars.watchers["roomID"].Current == vars.roomIDEnum["greenHills"];
    var belowSpazer = settings["belowSpazer"] && vars.watchers["roomID"].Old == vars.roomIDEnum["bat"] && vars.watchers["roomID"].Current == vars.roomIDEnum["belowSpazer"] && (vars.watchers["brinstarBosses"].Old & vars.bossFlagEnum["kraid"]) == 0;
    ...
    var warehouseKiHunters = settings["warehouseKiHunters"] && vars.watchers["roomID"].Old == vars.roomIDEnum["babyKraidRoom"] && vars.watchers["roomID"].Current == vars.roomIDEnum["warehouseKiHunters"];
    ...
    var leavingHiJumpBoots = settings["leavingHiJumpBoots"] && vars.watchers["roomID"].Old == vars.roomIDEnum["hiJumpShaft"] && vars.watchers["roomID"].Current == vars.roomIDEnum["businessCenter"];
    var hellway = settings["hellway"] && (vars.watchers["roomID"].Old == vars.roomIDEnum["redTower"] && vars.watchers["roomID"].Current == vars.roomIDEnum["hellway"] || vars.watchers["roomID"].Old == vars.roomIDEnum["caterpillar"] && vars.watchers["roomID"].Current == vars.roomIDEnum["hellway"]);
    ...
    var cacEntry = settings["cacEntry"] && vars.watchers["roomID"].Old == vars.roomIDEnum["halfieClimbRoom"] && vars.watchers["roomID"].Current == vars.roomIDEnum["eastCactusAlley"];
    ...
    var roomTransitions = miniBossRooms || bossRooms || elevatorTransitions || ceresEscape || theClimb || greenHills || belowSpazer || wreckedShipEntrance || redTowerBottomEntrance || kraidsLair || warehouseKiHunters || risingTideEntrance || leavingHiJumpBoots || hellway || atticExit || tubeBroken || cacEntry || cacExit || toilet || kronicBoost || lowerNorfairEntrance || writg || redKiShaft || metalPirates || lowerNorfairSpringMaze || lowerNorfairExit || tourianEntrance || goldenFour || metroids || babyMetroidRoom || escapeClimb;
